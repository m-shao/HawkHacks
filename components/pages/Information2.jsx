    ...
    >
      ...
      <div className="w-full flex flex-col items-center gap-8 justify-center h-full">
        ...
        <div className="w-full max-w-[55rem] text- p-6 text-2xl text-black bg-white rounded-2xl shadow-2xl leading-10">
          Basic queries in document-based databases allow you to retrieve and
          manipulate data efficiently using key-value pairs. You can perform
          operations like finding documents that match specific criteria,
          updating existing documents, or deleting documents. More info:
          <a
          ...
          Example For the petstores, a basic query to find all pets named{" "}
          {'"Spot"'} might look like this:
          <h1> db.books.find{'({ "name": "Spot" })'}</h1>
          <h1>
            To update the owner of Spot you could use:
            <br />
            db.books.updateOne{"("}
          </h1>
          {'{ "name": "Spot" },'} <br />
